...
export default function Press() {
  ...
  const seoPage = useMemo(
    () => ({
      ...
      description:
        "북오산자이 드포레 언론보도 페이지입니다. 김포 고촌 한강 생활권, 공급 정보, 청약, 입지환경, 모델하우스 방문예약 관련 공식 보도자료와 분양 소식을 확인하세요.",
      extraSchemas: [
        {
          "@context": "https://schema.org",
          "@type": "ItemList",
          "@id": `${getAbsoluteUrl(pressBasePath)}#press-list`,
          name: "북오산자이 드포레 언론보도 목록",
        ...
        <section className={styles.pressHero} aria-labelledby="pressTitle">
          <div>
            ...
            <p className={styles.pressLead}>
              ...
              모델하우스 방문예약까지 북오산자이 드포레의 공식 보도자료와
              분양 소식을 전합니다.
            </p>
          ...
          <div className={styles.pressStats} aria-label="북오산자이 드포레 주요 정보">
            <div>
